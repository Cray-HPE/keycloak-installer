...
class TestKeycloakSetup(testtools.TestCase):
    ...
    def test_k8s_apply_secret(self):
        ...
        self.assertEqual(secret.data['key'], base64.b64encode('value'))
    ...
    def test_k8s_apply_secret_no_change(self):
        ...
        existing_secret.data = {'key': base64.b64encode('value')}
    ...
    def test_k8s_apply_secret_update(self):
        existing_secret = mock.MagicMock()
        existing_secret.data = {'key': base64.b64encode('old-value')}
        ...
        self.assertEqual(secret.data['key'], base64.b64encode('new-value'))
